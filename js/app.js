(() => {
    ...
    const enjoy = document.querySelector(".condo-kings");
    const headerContainer = document.querySelector(".header__container");
    const logos = document.querySelector(".menu__logo");
    const getStiky = function(entries) {
        const entry = entries[0];
        if (!entry.isIntersecting) {
            navigation.style.position = "fixed";
            navigation.style.background = "#005ec9b3";
            headerContainer.style.paddingTop = "5px";
            headerContainer.style.paddingBottom = "5px";
            logos.classList.add("display-none");
        } else {
            navigation.style.position = "absolute";
            navigation.style.background = "#ffffff00";
            headerContainer.style.cssText = `@include adaptiveValue("padding-top", 24,15 );\n    @include adaptiveValue("padding-bottom", 24,15 );`;
            logos.classList.remove("display-none");
        }
    };
    ...
    const phoneMenu = document.querySelector(".icon-menu");
    document.querySelector(".hidden");
    phoneMenu.addEventListener("click", (function() {
        document.querySelector(".menu__phones").classList.toggle("hidden");
    }));
